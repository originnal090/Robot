...
校验。“路线均衡 Hybrid（推荐）”目前使用
`artifacts/edge-route-20260915/route-balanced-a146-v2/profile.json`；旧版本仍保留供回退。
详细评估和 OrangePi 板端基准命令见 `docs/edge-recognition.md` 与
`docs/edge-capture-update-20260915.md`。
